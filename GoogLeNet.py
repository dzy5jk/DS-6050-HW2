...
class InceptionBlock(nn.Module):
    ...
    def __init__(self, in_channels, ch1x1, ch3x3_reduce, ch3x3, ch5x5_reduce, ch5x5, pool_proj):
        ...
        self.branch_1 = nn.Sequential(
            nn.Conv2d(in_channels=in_channels, out_channels=ch1x1, kernel_size=1, bias=False),
        ...
        self.branch_2 = nn.Sequential(
            nn.Conv2d(in_channels=in_channels, out_channels=ch3x3_reduce, kernel_size=1, bias=False),
            nn.BatchNorm2d(ch3x3_reduce),
            nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=ch3x3_reduce, out_channels=ch3x3, kernel_size=3, padding=1, bias=False),
        ...
        self.branch_3 = nn.Sequential(
            nn.Conv2d(in_channels=in_channels, out_channels=ch5x5_reduce, kernel_size=1, bias=False),
            nn.BatchNorm2d(ch5x5_reduce),
            nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=ch5x5_reduce, out_channels=ch5x5, kernel_size=5, padding=2, bias=False),
        ...
        self.branch_4 = nn.Sequential(
            ...
            nn.Conv2d(in_channels=in_channels, out_channels=pool_proj, kernel_size=1, bias=False),
