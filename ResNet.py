...
class ResNet(nn.Module):
    def __init__(self, num_classes=18):
        ...
        self.residual_layer_1 = self._make_layer(64, 64, 2, 1)
        ...
        self.residual_layer_2 = self._make_layer(64, 128, 2, 2)
        ...
        self.residual_layer_3 = self._make_layer(128, 256, 2, 2)
        ...
        self.residual_layer_4 = self._make_layer(256, 512, 2, 2)
